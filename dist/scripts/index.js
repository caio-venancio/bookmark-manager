...
if (tabs && tabItems) { // Verifica se ambos os elementos existem
    ...
    if (!tabs)
        console.error("O elemento .tabs não foi encontrado.");
    if (!tabItems)
        console.error("O elemento .tab-items não foi encontrado.");
}
